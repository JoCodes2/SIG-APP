...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="bg-white shadow-md rounded-lg p-6 text-center">
            ...
            <p class="text-blue-500 text-3xl font-bold">1250</p>
        ...
        <div class="bg-white shadow-md rounded-lg p-6 text-center">
            ...
            <p class="text-blue-500 text-3xl font-bold">3</p>
        ...
        <div class="bg-white shadow-md rounded-lg p-6 text-center">
            ...
            <p class="text-blue-500 text-3xl font-bold">24</p>
        ...
        <div class="bg-white shadow-md rounded-lg p-6 text-center">
            ...
            <p class="text-blue-500 text-3xl font-bold">385</p>
...
@section('scripts')
<!-- Tambahkan jika ingin animasi atau efek scroll -->
@endsection
